app.service('CurrentServices', ['$http', '$q', function($http, $q) {
  ...
  */
  function getTrafficData (uaaToken, startTime, endTime, assetNumber) {
      ...
      var trafficEventsUrl = 'https://ie-traffic.run.aws-usw02-pr.ice.predix.io/v1/assets/' + assetNumber + '/events';
      ...
      $http({
            ...
            params: {'event-types':'TFEVT', 'start-ts':startTime, 'end-ts':endTime},
  ...
  */
  ...
  function getPitneyBowesToken() {
    var token = 'Basic ' + 'Vk04VThYbG5VbHYyM3hFT21oZzdmanlpeTBBWDhqNVU6RFFKbXJJOXZwQ3FHY0dmNw==';
